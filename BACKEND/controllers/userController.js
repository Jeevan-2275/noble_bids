...
export const register = catchAsyncErrors(async(req, res, next) => {
  ...
  if (role === "Auctioner") {  
    ...
    if (!PhonePeAccountNumber) {
      return next(
        new ErrorHandler("Please provide your PhonePe account number.", 400)
      );
    }
    if (!paypalEmail) {
  ...
  if (!cloudinaryResponse || cloudinaryResponse.error) {
    ...
    console.log("Full Cloudinary Response:", cloudinaryResponse); 
  ...
  console.log("c1 ",cloudinaryResponse )
