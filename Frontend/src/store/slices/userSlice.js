...
export const register = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://noble-bids-5.onrender.com/api/v1/user/register",
      data,
      {
...
export const login = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://noble-bids-5.onrender.com/api/v1/user/login",
      data,
      {
        withCredentials: true,
...
export const logout = () => async (dispatch) => {
  try {
    const response = await axios.get("https://noble-bids-5.onrender.com/api/v1/user/logout", {
      withCredentials: true,
    });
...
export const fetchUser = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get("https://noble-bids-5.onrender.com/api/v1/user/me", {
      withCredentials: true,
    });
...
export const fetchLeaderboard = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get("https://noble-bids-5.onrender.com/api/v1/user/leaderboard", {
      withCredentials: true,
    });
