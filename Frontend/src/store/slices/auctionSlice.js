...
export const getAllAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://noble-bids-5.onrender.com/api/v1/auctionitem/allitems",
...
export const getAuctionDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://noble-bids-5.onrender.com/api/v1/auctionitem/auction/${id}`,
      { withCredentials: true }
    );
...
export const createAuction = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://noble-bids-5.onrender.com/api/v1/auctionitem/create",
      data,
      {
        withCredentials: true,
...
export const republishAuction = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://noble-bids-5.onrender.com/api/v1/auctionitem/item/republish/${id}`,
      data,
      {
        withCredentials: true,
...
export const deleteAuction = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://noble-bids-5.onrender.com/api/v1/auctionitem/delete/${id}`,
      {
        withCredentials: true,
      }
    );
...
export const getMyAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://noble-bids-5.onrender.com/api/v1/auctionitem/myitems",
      { withCredentials: true }
    );
